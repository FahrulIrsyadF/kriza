...
async function pharmacyRoutes(app) {
  ...
  app.get('/drugs/expiring', async (request, reply) => {
  ...
  app.post('/drugs/adjustment', async (request, reply) => {
  ...
  app.get('/prescriptions/by-encounter/:encounterId', async (request, reply) => {
  ...
  app.post('/prescriptions/:id/cancel', async (request, reply) => {
  ...
  app.get('/shifts/active', async (request, reply) => {
    const active = await service.getActiveShift();
    return reply.send({ success: true, data: active });
  });

  app.get('/shifts/history', async (request, reply) => {
  ...
  app.put('/shifts/:id/items', async (request, reply) => {
  ...
  app.post('/shifts/:id/close', async (request, reply) => {
  ...
  app.get('/stock-opnames', async (request, reply) => {
    const { limit, page } = request.query;
  ...
  app.put('/stock-opnames/:id/items', async (request, reply) => {
  ...
  app.post('/stock-opnames/:id/finalize', async (request, reply) => {
